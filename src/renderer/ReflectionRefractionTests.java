...
public class ReflectionRefractionTests {
	...
	public void twoSpheres() {
		...
		ImageWriter imageWriter = new ImageWriter("images\\twoSpheres", 150, 150, 500, 500);
	...
	public void twoSpheresOnMirrors() {
		...
		ImageWriter imageWriter = new ImageWriter("images\\twoSpheresMirrored", 2500, 2500, 500, 500);
		Render render = new Render(imageWriter, scene);
	...
	public void trianglesTransparentSphere() {
		...
		ImageWriter imageWriter = new ImageWriter("images\\shadow with transparency", 200, 200, 600, 600);
		Render render = new Render(imageWriter, scene);
