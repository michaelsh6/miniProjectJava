...
public class SphereTest {
    ...
    public void TestFindIntersections() {
        ...
        p1 = new Point3D(1.707111011, 0.707111011, 0);
        result = sphere.findIntersections(new Ray(
                new Vector(0.5, 0.5, 0),new Point3D(0.5, 1.5, 0)));
        ...
        result= sphere.findIntersections(new Ray(
                new Vector(0.5, -1.5, 0),new Point3D(1, 1, 0)));
        assertEquals("Wrong number of points", 2, result.size());
        if (result.get(0).get_x().get() > result.get(1).get_x().get())
            result = List.of(result.get(1), result.get(0));
        assertEquals("Ray crosses sphere", List.of(p1, p2), result);
        ...
        p1 = new Point3D(1.7071067812, 0.7071067812, 0);
        p2 = new Point3D(0.2928932188, -0.7071067812, 0);
        result= sphere.findIntersections(new Ray(
        ...
        p1 = new Point3D(1, 1, 0);
        result = sphere.findIntersections(new Ray(
                new Vector(0, 1.5, 0),new Point3D(1, 0, 0)));
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Ray crosses sphere", List.of(p1), result);
        ...
        p1 = new Point3D(1, 1, 0);
        result = sphere.findIntersections(new Ray(
                new Vector(1, 0, 0),new Point3D(0, 1, 0)));
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Ray crosses sphere", List.of(p1), result);
        ...
        p1 = new Point3D(1, 1, 0);
        result = sphere.findIntersections(new Ray(
                new Vector(1, 0, 0),new Point3D(1, 1, 0)));
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Ray crosses sphere", List.of(p1), result);
