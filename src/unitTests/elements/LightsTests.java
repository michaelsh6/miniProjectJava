...
public class LightsTests {
    ...
    /**
     * Produce a picture of a sphere lighted by a spot light with  factor of 10 opening
     */
    @Test
    public void sphereSpotOpening() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        ...
        ImageWriter imageWriter = new ImageWriter("sphereSpotOpening", 150, 150, 500, 500);
        Render render = new Render(imageWriter, scene);
    ...
    public void trianglesSpotOpening() {
        ...
        ImageWriter imageWriter = new ImageWriter("trianglesSpotOpening", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
