...
public class ReflectionRefractionTests {
     ...
     */
    @Test
    public void IntegrationGeometriesReflected() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -10000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(10000);
        scene.setBackground(Color.BLACK);
        ...
        scene.addGeometries(
                new Sphere(new Color(0, 0, 100), new Material(0.25, 0.25, 20, 0.5, 0), 400, new Point3D(-950, 900, 1000)),
                new Sphere(new Color(100, 20, 20), new Material(0.25, 0.25, 20, 1, 0), 200, new Point3D(-950, 900, 1000)),
                new Sphere(new Color(0, 0, 100), new Material(0.25, 0.25, 20, 0, 0.8), 300, new Point3D(-850, 10, 500)),

                new Triangle(new Color(20, 20, 20), new Material(0, 0, 0, 0, 1), new Point3D(1500, 1500, 1500),
                        new Point3D(-1500, -1500, 1500), new Point3D(670, -670, -3000)),
                new Triangle(new Color(20, 20, 20), new Material(0, 0, 0, 0.5, 0.5), new Point3D(1500, 1500, 1500),
                        new Point3D(-1500, -1500, 1500), new Point3D(-1500, 1500, 2000)),
                new Plane(new Color(100, 120, 120), new Material(0.25, 0.25, 20, 0, 0.8),  new Point3D(100, 100, 100),
                        new Point3D(-100, -100, 100), new Point3D(70, -70, -300) ));

        scene.addLights(new SpotLight(new Color(1020, 400, 400),  new Point3D(-750, 750, 150),
                new Vector(-1, 1, 4), 1, 0.00001, 0.000005));

        ImageWriter imageWriter = new ImageWriter("IntegrationGeometriesReflected", 2500, 2500, 500, 500);
        Render render = new Render(imageWriter, scene);
